...
var functions = __importStar(require("../controllers/imageController"));
var imageObj = {
    id: '1921681254',
    imageName: 'tree',
    options: {
...
describe('A function to change an image from changeImage endpoint', function () {
    it('should create a new image dynamically.', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, functions.default.createNewImage(imageObj)];
                case 1:
                    result = _a.sent();
