 ...
 */
var changeImage = function (req, res) {
 ...
 */
var createNewImage = function (imageObj) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            (0, sharp_1.default)(''.concat(originalFilePath))
              .resize(imageObj.options.resize)
              .grayscale()
              .jpeg()
              .toFile(''.concat(updatedFilePath)),
          ];
        case 1:
          _a.sent();
          return [3 /*break*/, 4];
        ...
        case 3:
          ...
          _a.label = 4;
        case 4:
          return [2 /*return*/, 'New Image Created - '.concat(imageObj.imageName, '_').concat(imageObj.id, '!')];
        case 5:
          return [2 /*return*/, 'Resize object is missing width and/or height!'];
      }
    });
  });
};
