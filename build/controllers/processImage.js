 ...
 */
var createNewImage = function (imageObj, filePathObj) {
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            (0, sharp_1.default)(''.concat(filePathObj.originalFilePath))
        ...
        case 4:
          return [
            2 /*return*/,
            'New Image Created and Added to Gallery - '.concat(imageObj.imageName, '_').concat(imageObj.id, '!'),
          ];
      }
    });
  });
...
var createFilePathObj = function (imageObj) {
  ...
  return {
    pathExists: !fs_1.default.existsSync(originalFilePath)
      ? false
      : fs_1.default.existsSync(updatedFilePath)
      ? false
      : true,
...
var sendHTMLContent = function (res, resMessage, filePath, imageObj, pathExists) {
  ...
  var htmlInfo = '\n    <h2>'
    .concat(resMessage, '</h2>\n    <br><hr><br>\n    <ul>\n      <li>Image Used: ')
    .concat(imageObj.imageName, '</li>\n      <li>Passed ID: ')
    .concat(imageObj.id, '</li>\n      <li>Options:</li>\n        <ul>\n          <li>Height: ')
    .concat(imageObj.options.resize.height, '</li>\n          <li>Width: ')
    .concat(imageObj.options.resize.width, '</li>\n          <li>Grayscale: ')
    .concat(imageObj.options.grayscale, "</li>\n        </ul>\n    </ul>\n    <br><hr><hr><br>\n    <img src='")
    .concat(filePath, '\' alt="new image">\n  ');
  if (pathExists) {
